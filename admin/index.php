...
$response_transactions = file_get_contents("http://silverhappy_api:8080/api/transactions/last", false, $context);
$response_events = file_get_contents("http://silverhappy_api:8080/api/events", false, $context);
